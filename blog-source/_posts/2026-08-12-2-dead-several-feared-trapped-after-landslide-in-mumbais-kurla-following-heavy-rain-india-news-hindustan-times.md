---
layout: post
title: "🌧️ The Price of a Downpour: Unmasking Mumbai's Urban Fragility"
date: 2026-08-12 06:02:32 +0000
toc: true
tags: [mumbai, kurla, landslide, urban-planning, climate-change, disaster-management, monsoon, deccan-traps]
mermaid: true
description: >-
  We all know Mumbai as the "City of Dreams," a metropolis that simply refuses to stop. Whether it is the rhythmic chaos of the local trains—the city's 
image:
  path: "https://images.unsplash.com/photo-1642363034193-0c48ce49256f?ixid=M3w5ODUxMjJ8MHwxfHNlYXJjaHwxfHwyJTIwZGVhZCUyQyUyMHNldmVyYWx8ZW58MHwwfHx8MTc4NjUxNDU1MXww&ixlib=rb-4.1.0&fm=webp&w=1200&h=630&fit=crop"
  alt: "a close up of a street sign on the ground"
  photographer: "Richard Bell"
  photographer_url: "https://unsplash.com/@maplerockdesign"
  unsplash_url: "https://unsplash.com/photos/a-close-up-of-a-street-sign-on-the-ground-KXSOWB3pKQg"
---
...
```mermaid
graph TD
    A[Extreme Precipitation] --> B[Soil Infiltration]
    B --> C[Saturation of Saprolite Layer]
    C --> D[Increase in Pore Water Pressure]
    D --> E[Reduction in Internal Friction]
    E --> F[Slope Failure / Landslide]
    F --> G[Impact on Informal Settlements]
    G --> H[Casualties & Displacement]
    H --> I[Economic & Social Loss]
```
